  ...
  <div>
    <el-row :gutter="10" type="flex" justify="space-between" align="middle">
      <el-col v-if="extractType === 'Regex'" :span="5">
        <el-select :disabled="isReadOnly" class="extract-item" v-model="common.useHeaders"
                   :placeholder="$t('api_test.request.assertions.select_subject')" size="small">
    ...
    <el-row v-if="extractType === 'JSONPath'" :gutter="10" type="flex" justify="space-between" align="middle">
      <el-col>
        match_no:<el-input :disabled="isReadOnly" v-model="common.match" class="input_small" size="small" show-word-limit
                  :placeholder="$t('api_test.request.extract.match_no')"/>
      </el-col>
      <el-col>
        defaultValues:<el-input :disabled="isReadOnly" v-model="common.defaultValues" class="input_middle" size="small" show-word-limit
