<template>
  <el-form :model="request" :rules="rules" ref="request" label-width="100px">
    ...
    <el-tabs v-if="request.mode===2" v-model="activeName">
      ...
      <el-tab-pane :label="$t('api_test.request.processor.post_jdbc_script')" name="jdbcPreProcessor">
...
export default {
  ...
  components: {
    MsApiVariable, MsApiAssertions, ApiRequestMethodSelect,MsApiKeyValue,MsApiExtract,MsJsr233Processor,MsJdbcProcessor},
  props: {
